...
export default function ImagePage() {
  ...
  const isSubmitting = async (value: z.infer<typeof formSchema>) => {
    try {
      setImages([]);
      const response = await axios.post("/api/images", value);
  ...
  return (
    <div>
      <Heading
        ...
        description="Turn your prompt in to image"
        icon={ImageIcon}
      ...
      <div className="px-4 lg:px-8">
                ...
                render={({ field }) => (
                  <FormItem className="col-span-12 lg:col-span-6 ">
                    <FormControl className="m-0 p-0">
                      <Input
                        disabled={isLoading}
                        placeholder="a picture of lion in indian forest!"
        ...
        <div className="space-y-4 mt-4">
          ...
          {images.length === 0 && !isLoading && (
            <Empty label="No no images generated" />
          )}
